...
CREATE INDEX IF NOT EXISTS idx_unified_flows_ts ON unified_flows(ts);

-- Indices for time-window lookups
CREATE INDEX IF NOT EXISTS idx_unified_flows_id_orig_h_ts ON unified_flows("id.orig_h", ts);
CREATE INDEX IF NOT EXISTS idx_unified_flows_id_resp_h_ts ON unified_flows("id.resp_h", ts);
CREATE INDEX IF NOT EXISTS idx_unified_flows_id_orig_h_p_ts ON unified_flows("id.orig_h", "id.orig_p", ts);
CREATE INDEX IF NOT EXISTS idx_unified_flows_id_resp_h_p_ts ON unified_flows("id.resp_h", "id.orig_p", ts);
CREATE INDEX IF NOT EXISTS idx_unified_flows_service_ts ON unified_flows(service, ts);
CREATE INDEX IF NOT EXISTS idx_unified_flows_proto_ts ON unified_flows(proto, ts);
